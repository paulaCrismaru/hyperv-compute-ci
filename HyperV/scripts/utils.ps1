...
{ 
    <#
    .SYNOPSIS
    This Powershell commandlet executes a command and if it fails, executes it again. 
    The maximum number of retries is 10.
    .PARAMETER command
    The command to run.
    .PARAMETER maxRetryCount
    The number retries of the command to run if it fails. The default number of retries is 10.
    .PARAMETER retryInterval
    Time to wait before running the command again. The default number of seconds is 2.
    #>
...
function GitClonePull($path, $url, $branch="master")
{
    <#
    .SYNOPSIS
    Clones(if it's not cloned already) and pulls a git repo/branch in the specified directory.
    .PARAMETER path
    The path of the directory you want to clone/pull.
    .PARAMETER url
    The URL of the git repo.
    .PARAMETER branch
    The branch you want to clone/pull. Default branch is "master".
    #>
